...
$hx_exports["htmlparser"] = $hx_exports["htmlparser"] || {};
...
var htmlparser_CssSelector = $hx_exports["htmlparser"]["CssSelector"] = function(type) {
	this.classes = [];
	this.type = type;
};
...
var htmlparser_HtmlAttribute = $hx_exports["htmlparser"]["HtmlAttribute"] = function(name,value,quote) {
	this.name = name;
	this.value = value;
	this.quote = quote;
};
...
var htmlparser_HtmlNode = $hx_exports["htmlparser"]["HtmlNode"] = function() { };
...
var htmlparser_HtmlNodeElement = $hx_exports["htmlparser"]["HtmlNodeElement"] = function(name,attributes) {
	var _gthis = this;
...
var htmlparser_HtmlDocument = $hx_exports["htmlparser"]["HtmlDocument"] = function(str,tolerant) {
	if(tolerant == null) {
		tolerant = false;
	}
	if(str == null) {
...
var htmlparser_HtmlNodeText = $hx_exports["htmlparser"]["HtmlNodeText"] = function(text) {
	this.text = text;
};
...
var htmlparser_HtmlParser = $hx_exports["htmlparser"]["HtmlParser"] = function() {
};
...
var htmlparser_HtmlParserException = $hx_exports["htmlparser"]["HtmlParserException"] = function(message,pos) {
	this.message = message;
	this.line = pos.line;
...
var htmlparser_HtmlParserTools = $hx_exports["htmlparser"]["HtmlParserTools"] = function() { };
...
var htmlparser_HtmlTools = $hx_exports["htmlparser"]["HtmlTools"] = function() { };
...
var htmlparser_XmlBuilder = $hx_exports["htmlparser"]["XmlBuilder"] = function(indent,newLine) {
	if(newLine == null) {
		newLine = "\n";
	}
	if(indent == null) {
...
var htmlparser_XmlNodeElement = $hx_exports["htmlparser"]["XmlNodeElement"] = function(name,attributes) {
...
var htmlparser_XmlDocument = $hx_exports["htmlparser"]["XmlDocument"] = function(str) {
	if(str == null) {
		str = "";
	}
...
var htmlparser_XmlParser = $hx_exports["htmlparser"]["XmlParser"] = function() {
